...
var renderForm = function renderForm() {
  ...
  console.log(_form__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
var searchCode = function searchCode(term) {
  document.querySelector('form').addEventListener('submit', function (e) {
    e.preventDefault();
    var searchTerm = document.querySelector('.term').value;
    var searchResponse;
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (response) {
      ...
      if (searchResponse.data[0]) {
        ...
        document.querySelector('main').innerHTML += '<span>Paieska nesekminga</span>';
      }
    });
  });
};
